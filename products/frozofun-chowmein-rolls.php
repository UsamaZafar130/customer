<?php
// Auto-generated product display file for item: Chowmein Rolls
// Item ID: 95, Slug: frozofun-chowmein-rolls

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Chowmein Rolls | Chicken Chowmein Filled Rolls | FrozoFun";
$pageDescription = "Crispy rolls filled with savory chicken chowmein.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-chowmein-rolls.php';
        ...
        <ol class="breadcrumb">
            ...
            <?php if ($item['category_name']): ?>
                <li class="breadcrumb-item">
                    <a href="/products/?category=9"><?php echo h($item['category_name']); ?></a>
                </li>
            <?php endif; ?>
        ...
        <div class="col-md-6">
            ...
            <?php if ($item['category_name']): ?>
                <p class="text-muted">
                    ...
                    Category: <a href="/products/?category=9" class="text-decoration-none">
