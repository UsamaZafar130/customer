<?php
// Auto-generated product display file for item: Spring Roll
// Item ID: 65, Slug: frozofun-spring-roll

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Spring Roll | Crispy Vegetable Spring Roll | FrozoFun";
$pageDescription = "Crispy spring rolls with a savory vegetable filling.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-spring-roll.php';
