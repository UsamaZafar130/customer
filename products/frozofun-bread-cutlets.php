<?php
// Auto-generated product display file for item: Bread Cutlets
// Item ID: 93, Slug: frozofun-bread-cutlets

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Bread Cutlets | Crispy Bread & Potato Cutlets | FrozoFun";
$pageDescription = "Golden bread cutlets with a savory potato filling.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-bread-cutlets.php';
        ...
        <ol class="breadcrumb">
            ...
            <?php if ($item['category_name']): ?>
                <li class="breadcrumb-item">
                    <a href="/products/?category=6"><?php echo h($item['category_name']); ?></a>
                </li>
            <?php endif; ?>
        ...
        <div class="col-md-6">
            ...
            <?php if ($item['category_name']): ?>
                <p class="text-muted">
                    ...
                    Category: <a href="/products/?category=6" class="text-decoration-none">
