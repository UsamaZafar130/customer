<?php
// Auto-generated product display file for item: Tikka Boti Samosa
// Item ID: 57, Slug: frozofun-tikka-boti-samosa

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Tikka Boti Samosa | Spicy Chicken Tikka Samosa | FrozoFun";
$pageDescription = "Samosas filled with spicy tikka boti chicken.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-tikka-boti-samosa.php';
