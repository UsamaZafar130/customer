<?php
// Auto-generated product display file for item: Badam Sharbat 1L
// Item ID: 83, Slug: frozofun-badam-sharbat-1l

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Badam Sharbat 1L | Refreshing Almond Drink | FrozoFun";
$pageDescription = "Delicious and refreshing almond sharbat drink.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-badam-sharbat-1l.php';
        ...
        <ol class="breadcrumb">
            ...
            <?php if ($item['category_name']): ?>
                <li class="breadcrumb-item">
                    <a href="/products/?category=2"><?php echo h($item['category_name']); ?></a>
                </li>
            <?php endif; ?>
        ...
        <div class="col-md-6">
            ...
            <?php if ($item['category_name']): ?>
                <p class="text-muted">
                    ...
                    Category: <a href="/products/?category=2" class="text-decoration-none">
