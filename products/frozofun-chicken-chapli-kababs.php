<?php
// Auto-generated product display file for item: Chicken Chapli Kababs
// Item ID: 6, Slug: frozofun-chicken-chapli-kababs

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Chicken Chapli Kababs | Spicy Peshawari Kababs | FrozoFun";
$pageDescription = "Spicy chicken chapli kababs for an authentic taste.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-chicken-chapli-kababs.php';
