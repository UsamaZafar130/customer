<?php
// Auto-generated product display file for item: Chicken Seekh Kababs
// Item ID: 4, Slug: frozofun-chicken-seekh-kababs

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Chicken Seekh Kababs | Smoky Grilled Delicacy | FrozoFun";
$pageDescription = "Smoky grilled chicken seekh kababs, perfect for wraps.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-chicken-seekh-kababs.php';
