<?php
// Auto-generated product display file for item: Beef Seekh Kababs
// Item ID: 5, Slug: frozofun-beef-seekh-kababs

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Beef Seekh Kababs | Juicy Grilled Kababs | FrozoFun";
$pageDescription = "Juicy beef seekh kababs, ready-to-cook and delicious.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-beef-seekh-kababs.php';
