<?php
// Auto-generated product display file for item: Chicken Shami Kababs
// Item ID: 1, Slug: frozofun-chicken-shami-kababs

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Chicken Shami Kababs | Authentic Chicken & Lentil Patties | FrozoFun";
$pageDescription = "Juicy chicken and lentil kababs, perfect for every meal.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-chicken-shami-kababs.php';
