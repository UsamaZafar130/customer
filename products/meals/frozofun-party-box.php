<?php
// Auto-generated product display file for meal: Party Box
// Meal ID: 2, Slug: frozofun-party-box
...
// Set page variables
$pageTitle = "Party Box";
$pageDescription = "Party Box";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/meals/frozofun-party-box.php';
