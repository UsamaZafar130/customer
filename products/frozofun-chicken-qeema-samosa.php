<?php
// Auto-generated product display file for item: Chicken Qeema Samosa
// Item ID: 62, Slug: frozofun-chicken-qeema-samosa

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Chicken Qeema Samosa | Spiced Chicken Qeema Samosa | FrozoFun";
$pageDescription = "Samosa stuffed with flavorful chicken mince filling.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-chicken-qeema-samosa.php';
        ...
        <ol class="breadcrumb">
            ...
            <?php if ($item['category_name']): ?>
                <li class="breadcrumb-item">
                    <a href="/products/?category=8"><?php echo h($item['category_name']); ?></a>
                </li>
            <?php endif; ?>
        ...
        <div class="col-md-6">
            ...
            <?php if ($item['category_name']): ?>
                <p class="text-muted">
                    ...
                    Category: <a href="/products/?category=8" class="text-decoration-none">
