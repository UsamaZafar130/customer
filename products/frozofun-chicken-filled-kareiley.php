<?php
// Auto-generated product display file for item: Chicken Filled Kareiley
// Item ID: 92, Slug: frozofun-chicken-filled-kareiley

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Chicken Filled Kareiley | Bitter Gourd Stuffed with Chicken | FrozoFun";
$pageDescription = "Bitter gourd (kareiley) stuffed with savory chicken filling.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-chicken-filled-kareiley.php';
        ...
        <ol class="breadcrumb">
            ...
            <?php if ($item['category_name']): ?>
                <li class="breadcrumb-item">
                    <a href="/products/?category=4"><?php echo h($item['category_name']); ?></a>
                </li>
            <?php endif; ?>
        ...
        <div class="col-md-6">
            ...
            <?php if ($item['category_name']): ?>
                <p class="text-muted">
                    ...
                    Category: <a href="/products/?category=4" class="text-decoration-none">
