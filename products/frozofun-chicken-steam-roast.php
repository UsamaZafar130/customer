<?php
// Auto-generated product display file for item: Chicken Steam Roast
// Item ID: 91, Slug: frozofun-chicken-steam-roast

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Chicken Steam Roast | Tender Steamed Chicken Roast | FrozoFun";
$pageDescription = "Tender and juicy steamed chicken roast.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-chicken-steam-roast.php';
        ...
        <ol class="breadcrumb">
            ...
            <?php if ($item['category_name']): ?>
                <li class="breadcrumb-item">
                    <a href="/products/?category=1"><?php echo h($item['category_name']); ?></a>
                </li>
            <?php endif; ?>
        ...
        <div class="col-md-6">
            ...
            <?php if ($item['category_name']): ?>
                <p class="text-muted">
                    ...
                    Category: <a href="/products/?category=1" class="text-decoration-none">
