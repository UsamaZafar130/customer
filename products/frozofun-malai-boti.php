<?php
// Auto-generated product display file for item: Malai Boti 500g
// Item ID: 72, Slug: frozofun-malai-boti

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Malai Boti 500g | Creamy Chicken Malai Boti | FrozoFun";
$pageDescription = "Soft and creamy chicken malai boti, perfect for BBQs.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-malai-boti.php';
