<?php
// Auto-generated product display file for item: Tikka Boti 500g
// Item ID: 70, Slug: frozofun-tikka-boti

// Include init.php at the very top for PHP logic
require_once __DIR__ . '/../includes/init.php';

// Set page variables
$pageTitle = "Tikka Boti 500g | Spicy Chicken Tikka Boti | FrozoFun";
$pageDescription = "Juicy chicken tikka boti pieces, ready to cook.";
$canonicalUrl = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/products/frozofun-tikka-boti.php';
